...
| [ADR-0007](repo/0007-dual-scanner-openvex-default-deny.md) | Accepted | Use dual scanners and default-deny OpenVEX for unfixed HIGH and CRITICAL findings, with one exact expiring accept-and-track path. |
