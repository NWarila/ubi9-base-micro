...
| [ADR-0007](repo/0007-dual-scanner-openvex-default-deny.md) | Accepted | Use dual scanners and default-deny OpenVEX for unfixed HIGH and CRITICAL findings, with one exact expiring accept-and-track disposition and separately scoped legacy and dormant child-eligibility paths. |
...
| [ADR-0015](repo/0015-separate-python-policy-logic-from-shell-orchestration.md) | Accepted | Separate Python policy logic from shell orchestration. |
| [ADR-0016](repo/0016-remove-vulnerable-components-outside-supported-surfaces.md) | Accepted | Remove vulnerable components only outside declared supported surfaces. |
