...
| [ADR-0007](repo/0007-dual-scanner-openvex-default-deny.md) | Superseded | Historical dual-scanner default-deny OpenVEX policy, superseded by fixable blocking plus complete report-only evidence. |
