...
- **H2. `base-micro`:** uncompressed **<= 25 MB(u)** (rpmdb retained, FIPS library closure preserved); the STEP022/STEP023 sweep proved <=16 MB(u) infeasible with OpenSSL #4857 plus rpmdb, and STEP024 gates the stripped runtime at <=25 MB(u). **FAIL above 25 MB(u) without justification.**
