...
The current amd64 runtime measures 24,035,076 bytes / 22.9216 MiB against
the 25 MiB H2 gate; local OCI compressed layer sum is 12,111,841 bytes /
11.5508 MiB. See docs/footprint.md.
