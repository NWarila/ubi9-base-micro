...
For the Java variant (`java21/`), see the root README's
[Image Family](../README.md#image-family) section; the Node variant remains
planned. Every other variant must publish through its own
