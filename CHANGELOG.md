...
- Added an exact, expiring accept-and-track disposition for the known-affected
  ...
  refuses the disposition when either scanner supplies valid fix evidence, and
  has `review-by 2026-10-01`. It suppresses no raw finding, does not make the
  image unaffected, and is tracked as TD-9.
