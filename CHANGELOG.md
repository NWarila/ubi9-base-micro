...
- Moved base-python onto the base-micro index
  `sha256:81e604e496e11289f662610a8da60a4dcfa206b14f1d3d4e0239a35ff60b21f6`,
  whose floor carries `openssl-libs` `1:3.5.8-1.el9_8` and so fixes
  `CVE-2026-14456` in base-python. The floor also moves `glibc` to
  `2.34-275.el9_8` and `tzdata` to `2026c-1.el9_8`; the python RPM locks
